...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-entropy-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-entropy-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-entropy-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-entropy-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-entropy-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-entropy-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-entropy/badges/version.svg)](https://anaconda.org/conda-forge/r-entropy)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-entropy/badges/downloads.svg)](https://anaconda.org/conda-forge/r-entropy)
